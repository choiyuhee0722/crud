...
<link rel="stylesheet"
	...
	<script src="https://ajax.googleapis.com/ajax/libs/popper.js/jquery/3.3.1/jquery.min.js"></script>
...
<body>
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark" style="margin-bottom: 30px">
		<ul class="navbar-nav">
			...
			<li class="nav-item"><a class="nav-link" href="/view/memberList.do.jsp">모든회원보기</a></li>
		</ul>
	</nav>
</body>
</html>